...
async function setup() {
    ...
    GameInfo.sounds.attack.setVolume(0.06);
    GameInfo.sounds.healing.setVolume(0.06);
    GameInfo.sounds.background.setVolume(0.06);
    GameInfo.sounds.special.setVolume(0.06);
    GameInfo.sounds.mirror.setVolume(0.06);
    GameInfo.sounds.defense.setVolume(0.06);
    GameInfo.sounds.selection.setVolume(0.06);
    await  getGameInfo();
...
async function mouseClicked() {
    if (GameInfo.playerDeck && GameInfo.game.player.state != "Wating" && GameInfo.playerDeck.active == true) {
